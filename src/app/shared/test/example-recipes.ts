...
export const exampleRecipeList: Recipe[] = [
  ...
  },
  {
    ...
    difficulty: Difficulty.BEGINNER,
    imageUrl:
      'https://ichef.bbci.co.uk/food/ic/food_16x9_832/recipes/cornbread_86386_16x9.jpg',
    ingredients: [
      '375g plain flour',
      '225g cornmeal',
      '1 tsp salt',
  ...
  },
  {
    ...
    difficulty: Difficulty.BEGINNER,
    imageUrl:
      'https://www.maxpixel.net/static/photo/1x/Green-Vegetables-Beets-Purple-2861272.jpg',
    ingredients: [
  ...
  },
  {
    ...
    difficulty: Difficulty.BEGINNER,
    imageUrl:
      'https://upload.wikimedia.org/wikipedia/commons/thumb/9/95/Koukouvagia.jpg/220px-Koukouvagia.jpg',
    ingredients: [
      'oregano',
      'salt',
      'pepper',
  ...
  },
  {
    ...
    difficulty: Difficulty.ADVANCED,
    imageUrl:
      'https://images.unsplash.com/photo-1473093295043-cdd812d0e601?auto=format&fit=crop&w=2000&q=80',
    ingredients: [
      '1 lb. farfalle pasta',
  ...
  },
  {
    ...
    difficulty: Difficulty.BEGINNER,
    imageUrl:
      'https://images.pexels.com/photos/574111/pexels-photo-574111.jpeg?auto=compress',
    ingredients: [
  ...
  },
  {
    ...
    difficulty: Difficulty.BEGINNER,
    imageUrl:
      'https://images.media-allrecipes.com/userphotos/600x600/1003056.jpg',
    ingredients: [
      '1 pound bacon',
